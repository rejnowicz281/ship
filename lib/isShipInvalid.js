            ...
            (new_ship_cell) =>
                ...
                ships.some(
                    (ship) =>
                        ...
                        // if ship has adjacent cells, check if new_ship_cell is adjacent to any of them
                        ship.adjacent_cells?.some(
                            (adjacent_cell) =>
                                adjacent_cell.row === new_ship_cell.row && adjacent_cell.column === new_ship_cell.column
                        )
                )
        )
    );
